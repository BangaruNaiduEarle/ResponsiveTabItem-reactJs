...
class App extends Component {
  ...
  getFilteredProjectList = activeTabId => {
  ...
  render() {
    ...
    const filteredProject = this.getFilteredProjectList(activeTabId)
    return (
        ...
        <ul className="tabs-container">
          {tabsList.map(tabDetails => (
            <TabItem
              ...
              clickTabItem={this.onClickTabItem}
              isActiveTab={tabDetails.tabId === activeTabId}
            />
          ))}
        </ul>
